...
export const asyncRouterMap = [
  {
    ...
    children: [
      ...
      // Data (Level 0 - 4)
      {
        ...
        children: [
          ...
          // Exploratory
          {
            ...
            meta: { title: 'Data Exploratory', icon: 'dribbble', keepAlive: false }
          }
        ]
      },
      ...
      // SeqFlow
      {
        ...
        meta: { title: 'Workflow', icon: 'project', permission: ['table'], keepAlive: false },
        children: [
          {
      ...
      // Report
      {
        ...
        meta: { title: 'Report', icon: 'dot-chart', keepAlive: false },
        children: [
          {
