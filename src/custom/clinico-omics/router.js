...
export const asyncRouterMap = [
  {
    ...
    children: [
      ...
      // SeqFlow
      {
        ...
        meta: { title: 'Workflow', icon: 'project', permission: ['table'], keepAlive: true, tourStep: 'workflow' },
        children: [
          {
          ...
          },
          {
            ...
            meta: { title: 'Apps & Tools', icon: 'appstore', permission: ['table'], keepAlive: true, tourStep: 'appstore' }
          },
          {
...
export const constantRouterMap = [
...

  {
    ...
    props: route => ({ src: 'http://47.117.34.2', toPath: 'welcome' }),
