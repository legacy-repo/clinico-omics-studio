...
const app = {
  ...
  mutations: {
    ...
    TOGGLE_HIDDEN_HEADER: (state, hide) => {
      Vue.ls.set(DEFAULT_HIDDEN_HEADER, hide)
      state.hiddenHeader = hide
    },
  ...
  actions: {
    ...
    ToggleHiddenHeader({ commit }, hiddenHeader) {
      commit('TOGGLE_HIDDEN_HEADER', hiddenHeader)
    },
    ToggleFixedHeader({ commit }, fixedHeader) {
      if (!fixedHeader) {
        commit('TOGGLE_FIXED_HEADER_HIDDEN', false)
      } else {
        commit('TOGGLE_HIDDEN_HEADER', false)
      }
