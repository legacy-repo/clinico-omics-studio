          ...
          <a-form-item label="Models">
            <a-select
              v-decorator="[
                ...
                {
                  rules: [
                    { required: true, message: 'Please select your prediction models!', type: 'array' },
                  ],
                },
              ]"
              mode="multiple"
        ...
        <a-row :gutter="24">
          <a-col :span="12">
            <a-form-item label="File Name">
              <a-input
                disabled
                v-decorator="['file_name', { initialValue: fileName, rules: [{ required: true, message: 'Please input the patient id!' }] }]"
              />
            </a-form-item>
          </a-col>
          <a-col :span="12">
          ...
          <a-col :span="12">
            <a-form-item label="Data Category">
              <a-select
                v-decorator="[
                  'data_category',
                  { initialValue: 'Tissue Slide', rules: [{ required: true, message: 'Please select the data category!' }] },
                ]"
                placeholder="Select a option and change input text above"
              >
                <a-select-option value="Tissue Slide">
                  Tissue Slide
                </a-select-option>
              </a-select>
            </a-form-item>
